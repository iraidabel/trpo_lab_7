...
public class PositiveTest {
    ...
    public Object[] newUserData() {
        ...
        res[0] = new User(
                "Nic",
                "Beli",
                "todaydfjfsdkf@mail.com",
                "111111",
                29,
                "June",
                1999,
                "Pr. Universitetsky 100a",
                "Volgograd",
                21,
                "Texas",
                40002,
    ...
    public void mainTest(User user) {
        ...
        System.setProperty("webdriver.chrome.driver", "C:/Users/princ/AppData/Local/Google/Chrome/Application/chromedriver.exe");
        ...
        signInLink = (new WebDriverWait(driver, 10)).until(presenceOfElementLocated(By.className("login")));
        signInLink.click();
        ...
        // Дожидаемся, пока страница загрузится, и смотрим на содержимое ссылки в аккаунт. Оно должно быть равно firstname + " " + lastname
        nameLabel = (new WebDriverWait(driver, 10)).until(presenceOfElementLocated(By.cssSelector("a.account > span")));
